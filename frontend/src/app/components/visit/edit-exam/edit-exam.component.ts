...
import {autocompletefilter} from '../add-exam/add-exam.component';
...
export class EditExamComponent implements OnInit {
  ...
  saveExam(){
    ...
    this.examService.updateExam(visitId, this.exam).subscribe(
        response => {
          console.log(response);
          this.added = true;
          this.clearVisitData();
          this.openSnackBar('Exam edited successfully', 'Close');
          this.goBack();
        },
        error => {
